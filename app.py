...
import source_code.infrastructure.main.controller.LoginController as LogintRoutes

app = Flask(__name__, template_folder="static/templates")
app.secret_key = os.environ.get('TOOLIFY_SECRET_KEY')
app.add_url_rule('/', view_func=LogintRoutes.login)
app.add_url_rule('/redirect', view_func=LogintRoutes.redirect_page)
