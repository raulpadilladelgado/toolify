...
class RemoveNonRemixSongs:
    def __init__(self, spotify_wrapper: SpotifyWrapper, keywords_provider: KeywordsProvider):
    ...
    def apply(self, playlist_id: str) -> None:
        ...
        keywords: list[str] = self.keywords_provider.get_keywords()
        non_remix_songs: Optional[NonRemixSongs] = NonRemixSongs.of(songs, keywords)
